...
USvideos %>%
   filter(title == "MOST PAINFUL LIP PLUMPER EVER ... OMG!!!" | title == "FLIPPING OVER SUPERCAR! *GONE VERY WRONG*" | title == "IS THIS THE CAMERA OF THE FUTURE?" | title == "WE WANT TO TALK ABOUT OUR MARRIAGE" | title == "TOTAL FAIL! NATASHA DENONA HOLIDAY WTF" | title == "FACE SURGERY WITH MAKEUP" | title == "NEWBORN PETS AND A NEW APARTMENT" | title == "FIRST TIME IM DOING THIS! TALKS WITH LIZA." | title == "I TOOK THE $3,000,000 LAMBO TO CARMAX! They offered me......" | title == "ICE PRIMER? DOES IT WORK?!") %>%	
