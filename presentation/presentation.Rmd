...
Time_of_day_n %>%
  ...
  geom_text(stat = "identity", 
            aes(label = scales::percent(n/500)), 
...
Regular videos' overall proportion of dislikes: 0.001504847

Clickbait videos' proportion of dislikes: 0.003008789

---
```{r}
dislikes_prop <- data.frame(type = c("all videos", "clickbait videos"),
                            prop = c(0.001504847, 0.003008789)
                            )

ggplot(dislikes_prop, aes(x = type, y = prop))+
  geom_histogram(stat = "identity")+
  labs(x = "video types",
       y = "proportion",
       title = "Proportion of Dislikes",
...
When you add new variable into the model, the accuracy of prediction is improved.
New model is better
r seuqres are above 0.8, generally good models
no obvious improvement so we used the simple one 
