...
# Common categories in the top-500 popular videos
...
Common_category_ID <- USvideos %>%
  ...
  count(category_id) %>%
  arrange(desc(n)) %>%
  print(tbl_USvideos(USvideos), n = 3) 
...
# What time did the top 500 Youtuber videos upload?
=======
# What time did the top 100 Youtube videos upload?
>>>>>>> 6f8e29737d38f442d9f7836dc6678fb7dceeea36
