...
$$Proportion = \frac{Likes}{Views}$$

Proportion of dislikes for all videos: 0.001504847

Proportion of dislikes for clickbait videos: 0.003008789
...
model 1 adjust R square: 0.8328397

model 2 adjust R square: 0.8658459

RMSE:64469.13

RMSE2:58060.69

When new variable "comment_count" is added into the model, the accuracy of prediction has no obvious improvement. Since the values of both models' adjust R squares and Root Mean Squared Errors are close to each other.
Therefore, we use the first model for prediction as it's simpler.
