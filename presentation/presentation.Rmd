...
```{r popular-categories, echo = FALSE, warning = FALSE, include = FALSE}
USvideos %>%
  ggplot(aes(x = likes, y = views)) +
  geom_point() +
  scale_y_continuous(limits = c(1, 25000000)) +
  scale_x_continuous(limits = c(1, 500000)) +
